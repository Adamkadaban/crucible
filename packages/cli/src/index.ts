...
type GuestPolicyHealth = {
  ...
  readonly malwareTools?: Readonly<Record<string, string | null>>;
...
function renderGuestAgentHealth(
  ...
  if (policyHealth !== undefined) {
    lines.push(
      ...
      `- malware tools: ${formatToolMap(policyHealth.malwareTools)}`,
