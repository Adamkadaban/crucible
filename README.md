...
| `guest_upload_file`   | Stream a host file into a guest path.                                     |
| `guest_read_file`     | Read a small ASCII guest file inline; binary/large files return metadata. |
| `guest_download_file` | Stream a guest file into `artifacts/downloads/...` on the host.           |
