...
- [ ] Define network modes: `isolated`, `nat`, and `capture`, with `isolated` as default.
...
- [ ] Add threat model documentation covering malware escape assumptions, host file exposure,
...
- [ ] Add readiness checks for CDB/WinDbg, symbol path configuration, PowerShell version, service
      ...
      state.
- [ ] Add snapshot creation and restore commands using qcow2/QMP semantics with metadata in the
      artifact manifest.
